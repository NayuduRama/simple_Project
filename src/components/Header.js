          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex justify-between h-16">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <button
                  type="button"
                  className="bg-gray-100 p-5 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 "
                > 
                ...
                <button
                  type="button"
                  className="bg-gray-100 p-5 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2"
                > 
